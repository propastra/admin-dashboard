...
import { getProperties, API_BASE } from '../services/api';
                        ...
                        <Popup className="property-popup">
                            <div className="popup-content" onClick={() => navigate(`/property/${prop.id}`)}>
                                <div className="popup-image">
                                    <img
                                        src={prop.photos?.[0] ? `${API_BASE}${prop.photos[0]}` : 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=300'}
